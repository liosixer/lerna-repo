    ...
    <el-card class="cus-main-card main-card">
      ...
      <div class="card-content">
        ...
        >
          ...
          <el-table-column label="公告类别" width="100" align="center"
            >补充公告
          </el-table-column>
...
import { approveStatus, neimengAreaCode } from '@/config/data.config';
import { getGonggao } from './service';
export default {
  name: 'NatureIndexSupplyNotice',
  ...
  methods: {
    async getList() {
      ...
      // ggChange: 是否补充公告
      params = { ...params, ...{ systemFrom: 1, ggChange: 1 } };
