    ...
    <el-card class="cus-main-card main-card">
      ...
      <div class="card-content">
        ...
        >
          ...
          <el-table-column label="公告结束时间" width="180" align="center">
            <template #default="{row}">
...
const noticeType = ggType.filter((item) => [30, 40, 50].includes(item.code));
import { getGonggao } from './service';
export default {
  name: 'NatureMineralMineralNotice',
  ...
  methods: {
    async getList() {
      ...
      params = { ...params, ...{ systemFrom: 1, type: 30 } };
    ...
    handleReset() {
      ...
      this.searchForm.ggName = '';
      this.searchForm.fabuTime = null;
    },
    handleSearch() {
      this.getList();
