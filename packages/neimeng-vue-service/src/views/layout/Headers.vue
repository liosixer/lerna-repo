  ...
  <div class="header clearfix" :class="bdColor">
    <div class="logo fl">
      <a href="#">
        <img
          class="logo-img"
          src="../../assets/images/frame/sz_logo2.png"
          alt
        />
      </a>
      <span class="sys-name">服务系统</span>
    </div>
    <!-- <cur-time class="timer fl" style="margin-left: 30px"></cur-time> -->
          ...
          <ul>
            ...
            >
              <div class="second-styles">
                <div @click="chooseStyles('wight-red')">
                  <span>简洁红色</span>
                  <i
                    class="el-icon-check"
                    :class="{ i_active: isIchoosed3 }"
                  ></i>
                </div>
                <div @click="chooseStyles('dark-red')">
                  <span>经典红色</span>
                  <i
                    class="el-icon-check"
                    :class="{ i_active: isIchoosed4 }"
                  ></i>
                </div>
              </div>
              <li slot="reference">
    ...
    <div class="other-system fr">
      <div class="system-list" @click="goToOtherSystem(1)">
        <i class="iconfont iconfont-style icon-caigouxitong"></i>
        <span>招标系统</span>
      </div>
      <div class="system-list" @click="goToOtherSystem(3)">
        <i class="iconfont iconfont-style icon-zhuanjialunzhengguanli"></i>
        <span>投标系统</span>
      </div>
    </div>
    <el-dialog
...
export default {
  ...
  created() {
    ...
    document
      ...
      .classList.add(this.$store.state.frame.colors);
  },
  methods: {
    //跳转其他系统地址
    goToOtherSystem(type) {
      if (type === 1) {
        // 投标系统
        // window.open(
        //   `${window.location.protocol}//${window.location.host}/tj-jy-supervise/index.html#/dashboard`
        // );
      } else if (type === 2) {
        // 大数据分析
      } else if (type === 3) {
        ...
        // this.isGt
        //   ? window.open(
        //       `${config.requestUrl}/tj-zhuanjia/tokenLogin?t=${this.$store.state.loginCookie.access_token}`
        //     )
        //   : window.open(
        //       `${config.requestUrl}/tj-zhuanjia/tokenLogin?t=${this.$store.state.loginCookie.access_token}`
        //     );
    ...
    chooseStyles(type) {
      ...
      if (type == 'wight') {
        document
          .getElementsByTagName('body')[0]
          .classList.remove('dark', 'dark-red', 'wight-red', 'dark-blue');
      }
      if (type == 'dark') {
        document
          .getElementsByTagName('body')[0]
          .classList.remove('wight', 'dark-red', 'wight-red', 'dark-blue');
      }
      if (type == 'wight-red') {
        document
          .getElementsByTagName('body')[0]
          .classList.remove('dark', 'dark-red', 'wight', 'dark-blue');
      }
      if (type == 'dark-red') {
        document
          .getElementsByTagName('body')[0]
          .classList.remove('wight', 'dark', 'wight-red', 'dark-blue');
      }
      if (type == 'dark-blue') {
        document
          .getElementsByTagName('body')[0]
          .classList.remove('wight', 'dark', 'wight-red', 'dark-red');
      }
      document.getElementsByTagName('body')[0].classList.add(type);
      if (type == 'dark') {
        this.isIchoosed1 = false;
        this.isIchoosed2 = true;
        this.isIchoosed3 = false;
        this.isIchoosed4 = false;
        this.isIchoosed5 = false;
      } else if (type == 'wight') {
        ...
        this.isIchoosed4 = false;
        this.isIchoosed5 = false;
      } else if (type == 'wight-red') {
        this.isIchoosed1 = false;
        this.isIchoosed2 = false;
        this.isIchoosed3 = true;
        this.isIchoosed4 = false;
        this.isIchoosed5 = false;
