      ...
      <div class="card-content">
        ...
        >
          ...
          <template v-if="tabValue == 1">
            ...
            >
              <template #default="{row}">
                {{ row.pbTime | dateFormater('YYYY-MM-DD HH:mm:ss') }}
              </template>
            </el-table-column>
            <el-table-column
              key="6"
          ...
          <template v-if="tabValue == 2">
            ...
            <el-table-column key="14" label="状态" width="100" align="center">
              <template #default="{row}">
                {{ row.bdStatus }}
              </template>
            </el-table-column>
          ...
          <template v-if="tabValue == 3">
            ...
            <el-table-column key="25" label="状态" width="100" align="center">
              <template #default="{row}">
                {{ row.bdStatus }}
              </template>
            </el-table-column>
