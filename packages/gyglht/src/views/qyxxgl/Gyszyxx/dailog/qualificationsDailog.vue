<template>
  <el-dialog title="添加资质信息" :append-to-body="true" :visible.sync="dialogVisible" width="950px" :before-close="handleClose">
    <div class="q_body">
      <el-form :model="qForm" :rules="rules" ref="qForm" label-width="110px" label-position="right" size="small">
        <el-row :gutter="20">
          <el-col :span="12"
            ><el-form-item label="资质证书名称" prop="ziZhiZhengShuName"> <el-input v-model="qForm.ziZhiZhengShuName" size="small" placeholder="请输入"></el-input> </el-form-item
          ></el-col>
          <el-col :span="12"
            ><el-form-item label="资质证书编号" prop="ziZhiZhengShuBH"> <el-input v-model="qForm.ziZhiZhengShuBH" size="small" placeholder="请输入"></el-input> </el-form-item
          ></el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12"
            ><el-form-item label="资质证书级别" prop="ziZhiZhengShuJiBie">
              <el-input type="text" v-model="qForm.ziZhiZhengShuJiBie" placeholder="请输入"></el-input>
              <!-- <el-select
          ...
          <el-col :span="12">
            <el-form-item label="资质证书附件" prop="ziZhiZhengShuFuJianName">
              <el-input type="text" style="display:none" v-model="qForm.ziZhiZhengShuFuJianGuid" placeholder="请输入"></el-input>
              <upLoader
                action="/upload"
                :limitNum="1"
        ...
        <el-row :gutter="20">
          <el-col :span="12"
            ><el-form-item label="资质有效期开始时间" prop="ziZhiZhengShuStartTime">
              <el-date-picker v-model="qForm.ziZhiZhengShuStartTime" type="date" size="small" :picker-options="pickerOptionsStart" style="width: 100%" placeholder="选择日期">
              </el-date-picker></el-form-item
          ></el-col>
          <el-col :span="12"
            ><el-form-item label="资质有效期结束时间" prop="ziZhiZhengShuEndTime">
              <el-date-picker v-model="qForm.ziZhiZhengShuEndTime" type="date" size="small" :picker-options="pickerOptionsEnd" style="width: 100%" placeholder="选择日期">
              </el-date-picker> </el-form-item
          ></el-col>
          <el-form-item style="display:none"> <el-input v-model="qForm.ziZhiZhengShuFuJianGuid" placeholder="请输入"></el-input></el-form-item>
        </el-row>
      </el-form>
    </div>
    <span slot="footer" class="dialog-footer">
      <el-button @click="handleQCancel" size="small">取 消</el-button>
      <el-button type="primary" @click="handleQOK" size="small">确 定</el-button>
    </span>
  </el-dialog>
</template>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        ziZhiZhengShuName: [
          { required: true, message: "请输入资质证书名称", trigger: "blur" },
          {
            pattern: /^[\u4e00-\u9fa5a-z\d]+$/gi,
