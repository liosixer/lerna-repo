  ...
  <section class="container page-detail">
    <div class="global-title">
      ...
      <!-- <div class="global-title-box">
                <span class="global-title-name">招标人代表-详情</span>
    ...
    <div class="zbrdbAddContent global-content">
      <el-card>
        ...
        <div class="global-card-content">
          <el-form :model="zbrdbData" label-position="right" label-width="130px" width="100%" size="small">
            <el-row :gutter="20">
              <el-col :span="12">
      ...
      <el-card>
        ...
        <div class="global-card-content">
          ...
          <el-form :model="zbrdbFormData" label-position="right" label-width="130px" width="100%" size="small">
            <el-row :gutter="20">
              <el-col :span="12">
