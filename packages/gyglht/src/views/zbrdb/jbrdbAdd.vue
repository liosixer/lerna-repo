    ...
    <section class="container page-detail">
        <div class=" global-title">
            <PageCrumb :d="{ breadcrumbList: breadcrumbList }">
                <div slot="btns">
                    <el-button type="primary" size="small" :disabled="saved" @click="saveFunc(zbrdbData)"
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="姓名:" prop="name" class="flex_choose">
                                    <div class="flex_choose_input">
                                        <el-input placeholder="" v-model="zbrdbData.name" disabled></el-input>
                                    </div>
                            ...
                            <el-col :span="12">
                                <el-form-item label="身份证号码:" prop="idNo">
                                    <el-input placeholder="" v-model="zbrdbData.idNo" disabled></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="20">
                            ...
                            <el-col :span="12">
                                <el-form-item label="联系电话:" prop="phone">
                                    <el-input placeholder="" v-model="zbrdbData.phone" disabled></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="20">
                        ...
                        <el-row :gutter="20">
                            ...
                            <el-col :span="12">
                                <el-form-item label="所属地区:" prop="administrativeArea">
                                    <el-cascader size="large" :options="regionData"
                        ...
                        <el-row :gutter="20">
                            <el-col :span="24">
                                <el-form-item label="备注:">
                                    <el-input type="textarea" autosize placeholder="请输入" v-model="zbrdbData.beizhu"
                                              :rows="4">
                                    </el-input>
                                </el-form-item>
                            </el-col>
            ...
            <el-card>
                <div slot="header" class="clearfix">
                    ...
                    <el-tooltip placement="top" v-if="$store.state.logoType == 1">
                        <div slot="content">您可以在企业所属的集团架构下选择<br>与自己同属的企业/单位，将监标人共<br>享给企业</div>
                        <span class="tool"><img class="info-tit-form" src="@/assets/help.png"
                                                alt=""/></span>
                    </el-tooltip>
                    <el-button type="primary" @click="addGxQy" size="mini" class="fr">添加</el-button>
                </div>
                <div class="global-card-content">
