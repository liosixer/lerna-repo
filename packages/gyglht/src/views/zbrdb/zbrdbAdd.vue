  ...
  <section class="container page-detail">
      <div class="zbrdbAddHeader global-title">
          <PageCrumb :d="{ breadcrumbList: breadcrumbList }">
              <div slot="btns">
                  <el-button type="primary" :disabled="saved" @click="saveFunc(zbrdbData)" size="small" :loading="saveLoading">保存</el-button>
        ...
        <div class="zbrdbAddContent">
            <div class="userInfoDiv">
                ...
                <el-form :inline="true" :model="zbrdbData" :rules="zbrdbRuleData" ref="zbrdbData" class="zbrdbForm">
                    ...
                    <el-form-item label="银行联行号:" prop="bank_lianhanghao">
                        <el-input placeholder="请输入" v-model="zbrdbData.bank_lianhanghao"></el-input>
                    </el-form-item>
                    <div>
...
<!--                        </el-form-item>-->
                    ...
                    <el-form-item label="备注:" style="width: 100%">
                        <el-input type="textarea" autosize placeholder="请输入" :rows="4" v-model="zbrdbData.beizhu" style="width: 100%">
                        </el-input>
                    </el-form-item>
                </el-form>
            </div>
            <div class="zbrdbGxDiv">
                <div class="topDiv">
                    <ul>
                        <li>
                            <h3>招标人代表共享
                                <el-tooltip placement="top" v-if="$store.state.logoType == 1">
                                    <div slot="content">您可以在企业所属的集团架构下选择<br>与自己同属的企业/单位，将招标人代<br>表共享给其他企业</div>
                        ...
                        <li>
                            <el-button size="small" type="primary" @click="addGxQy">添加</el-button>
                        </li>
                    </ul>
                </div>
                <div class="bottomLine"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.zbrdbData.employer = this.$store.state.loginCookie.userInfo.name
            this.zbrdbData.employerCode = this.$store.state.loginCookie.userInfo.guid
