...
export default {
  ...
  methods: {},
  mounted(){
    if(this.$store.state.loginCookie.access_token===""&&window.location.href.indexOf("#/login")===-1&&window.location.hash!="#/"&&window.location.hash!="#/login"&&window.location.hash.indexOf("#/Register")==-1&&window.location.hash!="#/findPassword"){
