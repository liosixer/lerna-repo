...
const {regDev,cdnMap,externals,UglifyJsPluginOptions,splitChunksOptions} = require("./src/config/config.base")
module.exports = {
  outputDir: "dist",
  assetsDir: "static",
  ...
  chainWebpack(config) {
    ...
    config.optimization.splitChunks((regDev.test(process.env.NODE_ENV))? {} : splitChunksOptions)
  },
