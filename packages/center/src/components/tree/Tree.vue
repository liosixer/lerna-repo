<template>
  ...
  >
    <div class="tree_input" v-if="showInput">
      <el-tooltip class="item" effect="dark" :content="(showCheckbox || !objed)?text:selData[label]" placement="top-start">
        <el-input
        ...
        <el-input
          ...
          readonly
          @focus="handelShow(selData[label])"
          v-else
        ></el-input>
      </el-tooltip>
    </div>
    <div
      class="tree_selector_box tree_selector_box_down"
      v-show="show || !drop"
    >
