            ...
            <ul>
                <li>
                    <router-link to="/login">
                        <h2 v-if="$store.state.logoType == 1">中国电子科技集团电子采购平台 | 账号申诉</h2>
                    </router-link>
                </li>
                <li>
        ...
        <div class="contentDiv">
            <el-form :inline="true" :model="checkData" :rules="checkRuleData" ref="checkData" class="checkForm" label-position="left">
                ...
                <el-form-item label="申诉材料:" prop="fileId">
                    ...
                    <Uploader action="/upload" :buttonTxt="buttonTxt" @sucData="handleSucDataFddbrShenFenZhengBH"></Uploader>
                    <el-button type="text">账号申诉申请表模板.doc</el-button>
                </el-form-item>
                <el-form-item>
