          ...
          <el-table-column label="操作" min-width="180" align="left" fixed="right">
            <template slot-scope="{row}">
              <el-button-group class="operation-button-group">
                <el-button @click="handleDetail(row, 'edit')" size="mini" type="primary" plain class="operation-button" v-if="!row.creatorGuid">
                  <i class="iconfont icon-bianji2"><span>编辑</span></i>
                </el-button>
                <el-button @click="handleDel(row)" size="mini" type="info" plain class="operation-button" v-if="!row.creatorGuid">
