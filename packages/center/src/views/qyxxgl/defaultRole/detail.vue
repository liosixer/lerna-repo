            ...
            <el-card>
                ...
                <div class="global-card-content">
                    <el-form :model="formData" :rules="rules" ref="formData" size="small" label-width="120px"
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="角色名称:" prop="roleName">
                                    <el-input placeholder="请输入角色名称" v-model="formData.roleName" readonly></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="是否有效:" required prop="isYouXiao">
                                    <el-radio-group v-model="formData.isYouXiao">
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="市场主体:" prop="zhuTiLeiXing">
                                    <el-checkbox-group v-model="formData.zhuTiLeiXing" @change="zhutiChg">
                            ...
                            <el-col :span="12">
                                <el-form-item label="是否电力板块:" prop="isYouXiao" v-if="formData.zhuTiLeiXing.includes('B')">
                                    <el-radio-group v-model="formData.dianLiBanKuai" @change="bankuaiChg">
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item label="查看部门项目:">
                                    <el-radio-group v-model="formData.viewBuMenXM">
                            ...
                            >
                                <el-form-item label="查看部门:" prop="suoZaiBuMen"
                                    ...
                                    <el-checkbox-group v-model="formData.suoZaiBuMen">
                                        <el-checkbox label="A">所在部门</el-checkbox>
                                        <el-checkbox label="D">全部部门</el-checkbox>
                        ...
                        <el-row :gutter="20">
                            <el-col :span="12">
                                <el-form-item prop="viewQiTaQiYe" label="其他企业项目:" required>
                                    <el-radio-group v-model="formData.viewQiTaQiYe">
                                        <el-radio label="1">具备</el-radio>
                                        <el-radio label="0">不具备</el-radio>
                                        <el-tooltip placement="top" v-if="$store.state.logoType == 1">
                            ...
                            <el-col :span="12">
                                <el-form-item label="项目类型:" prop="xmLeiXing" v-if="formData.viewQiTaQiYe == 1">
                                    <el-checkbox-group v-model="formData.xmLeiXing">
                                        <el-checkbox label="1">工程</el-checkbox>
                                        <el-checkbox label="2">货物</el-checkbox>
                                        <el-checkbox label="3">服务</el-checkbox>
                                    </el-checkbox-group>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <!-- <el-row :gutter="20">
                            <el-col>
                                <el-form-item label="评标复核权限:">
                                    <el-radio-group v-model="formData.isHasPBFuHeQuanXian">
                                        <el-radio label="1">具备</el-radio>
                                        <el-radio label="0">不具备</el-radio>
                                        <el-tooltip placement="top" v-if="$store.state.logoType == 1">
                                            <div slot="content">勾选所在部门，则查看所在部门的对应项目，勾选其他部门，需要选择该角色可查看的部门</div>
            ...
            <el-card>
                ...
                <div class="global-card-content">
                    <self-table border :data="formData.jyUserList" stripe style="width: 100%">
                        ...
                        <el-table-column prop="user_BH" label="身份证号码" min-width="120" align="right"></el-table-column>
...
<script>
    import Tree from "@/components/tree/treeFromQyglht";
    import {
        saveRules,
        getRules,
        getUserList,
        ...
        getDepartment
    } from "@/service/defaultRoleManagement";
    ...
    export default {
        data() {
            ...
            return {
                ...
                breadcrumbList: [
                    {label: "默认角色管理", link: "/qyxxgl/defaultRole"},
                    {label: "分配权限", link: ""},
                ],
                tempAuthGuid: ''//用于存储权限guid
            };
        },
        created() {
        ...
        methods: {
            getAllTree() {//获取树结构
                getRules({
                    zhuTiLeiXing: this.formData.zhuTiLeiXing.join(),
                    dianLiBanKuai: this.formData.dianLiBanKuai
                }).then((res) => {
                    this.rulesNodes = res;
                    this.formData.authGuid = this.tempAuthGuid//赋值那些被选上
                    this.loaded = true;
                }).catch((e) => {
                });
            },
            getDetail() {
                getAthDetail({guid: this.$route.query.id}).then((res) => {
                    if (res.code === 1) {
                        ...
                        datas.zhuTiLeiXing = !datas.zhuTiLeiXing ? ["B"] : datas.zhuTiLeiXing.split(",");
                        if(typeof(datas.dianLiBanKuai) != 'boolean'){
                            datas.dianLiBanKuai = true;
                        }
                        ...
                        this.tempAuthGuid = datas.authGuid
            ...
            zhutiChg(val){//主体类型切换时  树要对应变化
                this.getAllTree()
            },
            bankuaiChg(val){//是否电力板块  树要对应变化
                this.getAllTree()
            },
            handleSelect(e, r) {
            ...
            handleSaveRules() {
                ...
                if (data.zhuTiLeiXing.includes('B')) {
                    data.dianLiBanKuai = data.dianLiBanKuai
                } else {
                    data.dianLiBanKuai = null
                }
                data.zhuTiLeiXing = data.zhuTiLeiXing.join(",");
            ...
            handleUserClose() {
                ...
                this.$refs.userTable && this.$refs.userTable.$refs.selfTable.clearSelection();
                this.usersSelection = [];
            },
            // 显示添加用户弹出
            handleAddUserShow() {
