    ...
    <!-- </div>
      <div class="global-content">
        ...
        <div class="search-btnGroud" slot="btns">
          ...
          <el-form ref="serachForm" :model="params" class="global-form-top-line" label-width="100px" size="small" label-position="right">
        ...
        <div class="global-content">
          ...
          <div class="global-content-detail">
            <self-table border :data="tableData" :fit="true" ref="table" v-loading="serachFlag"  :height="tableHeight">
                ...
                <el-table-column prop="submitTime" sortable label="专业申请时间" min-width="150px"  show-overflow-tooltip>
                ...
                <el-table-column prop="shenPiJiBie" label="操作" min-width="120" align="left" fixed="right" show-overflow-tooltip>
                  <template slot-scope="scope">
                    <el-button-group class="operation-button-group">
                      <el-button type="primary" plain class="operation-button" size="small" @click="handleCheck(scope.row.guid)">
                        <i :class="scope.row.status !== 1 ? 'iconfont icon-anniutubiao-': 'iconfont icon-shenpi'"><span>{{scope.row.status !== 1 ? '查看': '审核'}}</span></i></el-button>
                    </el-button-group>
                  </template>
                </el-table-column>
            </self-table>
...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          handleCheck (guid) {
            this.$router.push({name: 'supplierDetail', query: {guid}})
          },
