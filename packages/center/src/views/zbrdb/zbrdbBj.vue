    ...
    <section class="container">
        ...
        <div class="zbrdbAddContent">
            <div class="userInfoDiv">
                ...
                <el-form :inline="true" :model="zbrdbData" :rules="zbrdbRuleData" size="small" ref="zbrdbData" class="zbrdbForm">
...
<!--                        <el-button type="primary" @click="checkSsdwFunc">选择</el-button>-->
                    ...
                    <el-form-item label="备注:" style="width: 100%">
                        <el-input type="textarea" :rows="4" autosize placeholder="请输入" v-model="zbrdbData.beizhu" style="width: 100%">
                        </el-input>
                    </el-form-item>
                </el-form>
            </div>
            <div class="zbrdbGxDiv">
                <div class="topDiv">
                    <ul>
                        ...
                        <li>
                            <el-button type="primary" size="small" @click="addGxQy">添加</el-button>
                        </li>
                    </ul>
                </div>
                <div class="bottomLine"></div>
                <self-table border :data="zbrdbGxData" header-cell-class-name="headercell" style="width:100%;margin:0;" :fit="true">
                    ...
                    <el-table-column fixed="right" label="操作" min-width="100" align="left">
                        <template slot-scope="scope">
                            <el-button type="primary" plain class="operation-button" size="small" @click="deleteGxQy(scope.$index,zbrdbGxData)">
