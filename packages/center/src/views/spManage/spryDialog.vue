    ...
    <section class="container">
        <el-dialog title="添加审批人员"
            ...
            <self-table border :data="allQiYeTableData" height="422px" @selection-change="handleSelectionChange" header-cell-class-name="headercell"
                ...
                <el-table-column prop="iDCard" label="身份证号码" min-width="150px" show-overflow-tooltip></el-table-column>
                <el-table-column prop="departName" label="所属部门" min-width="150px" show-overflow-tooltip></el-table-column>
